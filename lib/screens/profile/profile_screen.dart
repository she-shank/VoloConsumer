...
class _ProfileScreenState extends State<ProfileScreen> {
    ...
    return BlocBuilder<ProfileCubit, ProfileState>(
      ...
      builder: (context, state) {
        return Scaffold(
            ...
            body: state.map(
                loading: (Loading loading) => loadingView(),
                ready: (Ready readyState) => readyView(readyState),
                error: (Error error) => Container())
            //readyView(pageHeight, state, pageWidth)
            );
      },
    );
  }
  ...
  SingleChildScrollView readyView(Ready readyState) {
          ...
          Container(
            ...
            child: Padding(
              ...
              child: CarouselSlider(
                ...
                items: readyState.profile.carouselImageURLs!
                    .map((url) => SizedBox(
                        height: 200,
                        width: 200,
                        child: Image.network(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: GestureDetector(
                      onTap: () {},
                      //_profileCubit.openMap(state.maybeMap(orElse: ()=> )),
                      child: Row(
                        children: [
                          Icon(
                            Icons.location_on,
